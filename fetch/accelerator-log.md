...
┃ ┃ ┃ ┃ ┃ ┃ Debug .gitignore didn't match [cloudevents/func.py] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore didn't match [cloudevents/func.py] -> excluded
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-function->python-function, main->fetch]
